...
class SATPlanningViewController: UIViewController {
    ...
    @IBAction func onClickFinish(_ sender: Any){
        ...
        // returns to planning screen after sending SAT Planning Data to helper
        else {
            ...
            alert.addAction(UIAlertAction(title: "Done", style: .default, handler: { action in
                self.helper.addSATPlanning(days: self.selectedDays, date: self.selectedSATDate)
